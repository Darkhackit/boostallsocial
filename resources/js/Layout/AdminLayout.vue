...
<script>
import Breadcrumbs from "@/AdminComponents/Breadcrumbs/index.vue";
import Footer from "@/AdminComponents/Footer/index.vue";
import Header from "@/AdminComponents/Header/index.vue";
import Settings from "@/AdminComponents/Settings/index.vue";
import Sidebar from "@/AdminComponents/Sidebar/index.vue";
import window from "@/mixins/window";
import MobileSidebar from "@/AdminComponents/Sidebar/MobileSidebar.vue";
import FooterMenu from "@/AdminComponents/Footer/FooterMenu.vue";
...
export default {
    ...
    methods: {
        switchHeaderClass() {
            ...
            } else if (this.$store.themeSettingsStore.sidebarCollaspe) {
